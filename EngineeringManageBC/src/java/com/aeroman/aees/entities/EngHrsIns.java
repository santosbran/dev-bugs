...
@Entity
@Cacheable(false)
@Table(name = "ENG_HRS_INS")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EngHrsIns.findAll", query = "SELECT e FROM EngHrsIns e"),
    @NamedQuery(name = "EngHrsIns.findByEhiId", query = "SELECT e FROM EngHrsIns e WHERE e.ehiId = :ehiId"),
    @NamedQuery(name = "EngHrsIns.findByEhiName", query = "SELECT e FROM EngHrsIns e WHERE e.ehiName = :ehiName"),
    @NamedQuery(name = "EngHrsIns.findByEhiCodUsrIns", query = "SELECT e FROM EngHrsIns e WHERE e.ehiCodUsrIns = :ehiCodUsrIns"),
    @NamedQuery(name = "EngHrsIns.findByEhiDateIns", query = "SELECT e FROM EngHrsIns e WHERE e.ehiDateIns = :ehiDateIns"),
    @NamedQuery(name = "EngHrsIns.findByEhiCodUsrUpd", query = "SELECT e FROM EngHrsIns e WHERE e.ehiCodUsrUpd = :ehiCodUsrUpd"),
    @NamedQuery(name = "EngHrsIns.findByEhiDateUpd", query = "SELECT e FROM EngHrsIns e WHERE e.ehiDateUpd = :ehiDateUpd")})
public class EngHrsIns implements Serializable {
    ...
    public EngHrsIns(BigDecimal ehiId) {
        this.ehiId = ehiId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EngHrsIns)) {
            return false;
        }
        EngHrsIns other = (EngHrsIns) object;
