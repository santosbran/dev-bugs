...
@Entity
@Cacheable(false)
@Table(name = "ENG_DENT_INI")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EngDentIni.findAll", query = "SELECT e FROM EngDentIni e"),
    @NamedQuery(name = "EngDentIni.findByDenId", query = "SELECT e FROM EngDentIni e WHERE e.denId = :denId"),
    @NamedQuery(name = "EngDentIni.findByDenDiscrepancy", query = "SELECT e FROM EngDentIni e WHERE e.denDiscrepancy = :denDiscrepancy"),
    @NamedQuery(name = "EngDentIni.findByDenRefEvaluated", query = "SELECT e FROM EngDentIni e WHERE e.denRefEvaluated = :denRefEvaluated"),
    @NamedQuery(name = "EngDentIni.findByDenAttachments", query = "SELECT e FROM EngDentIni e WHERE e.denAttachments = :denAttachments"),
    @NamedQuery(name = "EngDentIni.findByDenReqAct", query = "SELECT e FROM EngDentIni e WHERE e.denReqAct = :denReqAct"),
    @NamedQuery(name = "EngDentIni.findByDenDateTime", query = "SELECT e FROM EngDentIni e WHERE e.denDateTime = :denDateTime"),
    @NamedQuery(name = "EngDentIni.findByDenTemplateData", query = "SELECT e FROM EngDentIni e WHERE e.denTemplateData = :denTemplateData"),
    @NamedQuery(name = "EngDentIni.findByDenAircraftGround", query = "SELECT e FROM EngDentIni e WHERE e.denAircraftGround = :denAircraftGround"),
    @NamedQuery(name = "EngDentIni.findByDenCritical", query = "SELECT e FROM EngDentIni e WHERE e.denCritical = :denCritical")})
public class EngDentIni implements Serializable {
    private static final long serialVersionUID = 1L;
    // @Max(value=?)  @Min(value=?)//if you know range of your decimal fields consider using these annotations to enforce field validation
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ENG_DENT_INI_SEQ")
    @SequenceGenerator(name = "ENG_DENT_INI_SEQ", sequenceName = "ENG_DENT_INI_SEQ", allocationSize = 1)
    ...
    public EngDentIni(BigDecimal denId) {
        this.denId = denId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EngDentIni)) {
            return false;
        }
        EngDentIni other = (EngDentIni) object;
    ...
    public String toString() {
        return "com.aeroman.aees.entities.EngDentIni[ denId=" + denId + " ]";
    }
